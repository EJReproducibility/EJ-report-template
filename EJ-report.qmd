...
The ReadMe file is adequate and includes **all** of the following items:
...
-   [ ] Empirical with available data.
    ...
    <summary>Click for sub-boxes</summary>
